/**
 * Internal CRUD helpers shared by the masterdata feature services — the same
 * `paginate`/`ensure` shape every @ra cluster inlines, factored here because this cluster
 * spans two feature services over nine tables.
 */
import type { Page } from './cluster-masterdata.dtos.js';
