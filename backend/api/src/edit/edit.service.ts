...
const REGISTRY: Record<string, ResourceCfg> = {
  ...
  'vendor-negotiations': { schema: 'procurement', table: 'vendor_negotiation', pk: 'vendor_negotiation_id', perm: 'procurement:quotation:write', cols: { revisedRate: 'revised_rate', notes: 'notes', recommendation: 'recommendation', status: 'status' } },
