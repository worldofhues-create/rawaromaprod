/**
 * Internal CRUD helpers shared by the inventory feature services — the same
 * `paginate`/`ensure` shape every @ra cluster inlines, factored here because this cluster
 * spans five feature services over nineteen tables.
 */
import type { Page } from './cluster-inventory.dtos.js';
